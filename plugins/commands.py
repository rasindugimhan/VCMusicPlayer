...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton("🔥 Source Code 🔥", url='https://t.me/Mr_RG_YT'),
    ],
    [
        InlineKeyboardButton('👥 Group', url='https://t.me/youtubesupportgroupforall'),
        InlineKeyboardButton('Channel 📢', url='https://t.me/Mr_RG_YT'),
    ],
    [
